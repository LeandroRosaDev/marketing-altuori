...
export default function Home() {
  return (
    <main>
      <section id="sobre" className="bg-[#DDD8D3] py-12 px-4 md:px-12">
        <div className="max-w-7xl mx-auto relative">
          <div className="flex flex-col gap-8">
            ...
            <div className="space-y-16 lg:space-y-0 lg:flex text-center lg:text-start">
              ...
              <div className="space-y-16 w-[80%] lg:w-[40%] md:ml-9 lg:ml-20 mx-auto">
      ...
      <section id="planos" className="bg-[#474747] py-24">
        <h1 className="text-3xl md:text-5xl font-bold text-white w-[80%] md:w-[70%] xl:w-[50%] md:text-start text-center mx-auto md:ml-12 mb-12">
        ...
        <div className="xl:w-full flex flex-col items-center">
          ...
          w-[80%] md:w-[70%] xl:w-[50%] mb-12 lg:text-center"
          >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 px-14 lg:px-0 xl:flex">
            <div className="bg-yellow-500 text-center p-8 rounded-lg shadow-lg flex flex-col justify-between h-[550px] sm:h-[600px] lg:w-[65%] mx-auto xl:w-72 2xl:w-80">
              ...
              <div className="mb-4">
                <p className="line-through text-lg md:text-2xl font-bold">
                  R$ 799,99
                </p>
                <p className="text-3xl md:text-4xl font-extrabold">R$ 299,99</p>
              </div>
              <a
                href="#"
                className="text-white bg-black px-4 py-2 rounded-full font-semibold mx-auto lg:w-[90%]"
              >
                Clique e Saiba Mais
              </a>
            </div>

            <div className="bg-yellow-500 text-center p-8 rounded-lg shadow-2xl h-[620px] sm:h-[600px] flex flex-col justify-between lg:w-[65%] xl:w-72 2xl:w-80 mx-auto">
              <h1 className="text-3xl font-bold mb-4 md:text-4xl">
                Plano Avançado
              </h1>
              <p className="mb-4 text-lg md:text-xl">
              ...
              <div className="mb-4">
                ...
                <p className="text-3xl md:text-4xl font-extrabold">R$ 799,99</p>
              </div>
              <a
                href="#"
                className="text-white bg-black px-4 py-2 rounded-full font-semibold lg:w-[90%] mx-auto"
              >
                Clique e Saiba Mais
              </a>
            </div>
            <div className="bg-yellow-500 text-center p-8 rounded-lg h-[620px] sm:h-[600px] lg:h-[700px] flex flex-col justify-between lg:w-[65%] xl:w-72 2xl:w-80 mx-auto">
              <h1 className="text-3xl font-bold mb-4 md:text-4xl">
                Plano Intermediário
              </h1>
              <p className="mb-4 md:text-lg">
                ...
                para o seu negócio + Gestão e Engajamento Redes Sociais,
                curtidas, comentários e seguidores.
              </p>
              <div className="mb-4">
                <p className="line-through md:text-xl font-bold">R$ 1599,99</p>
                <p className="text-2xl md:text-4xl font-extrabold">R$ 699,99</p>
              </div>
              <a
                href="#"
                className="text-white bg-black px-4 py-2 rounded-full font-semibold lg:w-[90%] mx-auto"
            ...
            <div className="bg-yellow-500 text-center p-8 rounded-lg h-[620px] sm:h-[600px] lg:h-[700px] flex flex-col justify-between lg:w-[65%] xl:w-72 2xl:w-80 mx-auto">
              <h1 className="text-3xl font-bold mb-4 sm:text-2xl md:text-3xl lg:text-4xl">
                Plano Advantage Pro
              </h1>
              <p className="mb-4 md:text-lg">
                ...
                catálogos, criação de numeros empresariais, gestão de multiplos
                atendimentos, métodos de pagamento e entrega.
              </p>
              <div className="mb-4">
                <p className="line-through text-lg font-bold">RS 4999,00</p>
      ...
      <section id="contato" className="bg-[#DDD8D3] flex">
        ...
        <div className="mx-auto md:flex md:justify-center md:items-center">
          <div className="w-full pt-8 md:pt-0">
            <div className="mb-8">
              <h1 className="text-2xl lg:text-3xl font-semibold text-center md:text-start text-[#333333] md:p-6">
